...
#define	RK_AES_HASH_RX	(0U)
#define	RK_AES_HASH_TX	(1U)

#define	_SBF(s,	v)			((u32)((u32)(v) << (s)))
#define	_BIT(b)				_SBF(b,	1U)

#define	DES_KEYSIZE			(8U)
#define	TDES_EDE_KEYSIZE		(24U)
#define	AES_KEYSIZE_128			(16U)
#define	AES_KEYSIZE_192			(24U)
#define	AES_KEYSIZE_256			(32U)
#define	SM4_KEYSIZE			(16U)

#define	DES_BLOCK_SIZE			(8U)
#define	AES_BLOCK_SIZE			(16U)
#define	SM4_BLOCK_SIZE			(16U)

#define	CRYPTO_WRITE_MASK_SHIFT		(16U)
#define	CRYPTO_WRITE_MASK_ALL		((u32)((0xffffUL << CRYPTO_WRITE_MASK_SHIFT)))

#define	WRITE_MASK			(16U)
...
#define	CRYPTO_CH0_IV_0			0x0100U
...
#define	CRYPTO_CH0_KEY_0		0x0180U
...
#define	CRYPTO_CH0_TAG_0		0x0320U
...
#define CRYPTO_AES_VERSION		0x0680U
#define CRYPTO_DES_VERSION		0x0684U
#define CRYPTO_SM4_VERSION		0x0688U

#define CRYPTO_ECB_FLAG			_BIT(0)
#define CRYPTO_CBC_FLAG			_BIT(1)
#define CRYPTO_CTS_FLAG			_BIT(2)
#define CRYPTO_CTR_FLAG			_BIT(3)
#define CRYPTO_CFB_FLAG			_BIT(4)
#define CRYPTO_OFB_FLAG			_BIT(5)
#define CRYPTO_XTS_FLAG			_BIT(6)
#define CRYPTO_CCM_FLAG			_BIT(7)
#define CRYPTO_GCM_FLAG			_BIT(8)
#define CRYPTO_CMAC_FLAG		_BIT(9)
#define CRYPTO_CBCMAC_FLAG		_BIT(10)

#define CRYPTO_AES128_FLAG		_BIT(16)
#define CRYPTO_AES192_FLAG		_BIT(17)
#define CRYPTO_AES256_FLAG		_BIT(18)

#define CRYPTO_TDES_FLAG		_BIT(16)

#define CRYPTO_LOCKSEP_FLAG		_BIT(20)
#define CRYPTO_SECURE_FLAG		_BIT(21)
#define CRYPTO_MULTI_CHN_FLAG		_BIT(22)

#define CRYPTO_HASH_VERSION		0x068CU
#define CRYPTO_HASH_SHA1_FLAG		_BIT(0)
#define CRYPTO_HASH_SHA224_FLAG		_BIT(1)
#define CRYPTO_HASH_SHA256_FLAG		_BIT(2)
#define CRYPTO_HASH_SHA384_FLAG		_BIT(3)
#define CRYPTO_HASH_SHA512_FLAG		_BIT(4)
#define CRYPTO_HASH_SHA512_224_FLAG	_BIT(5)
#define CRYPTO_HASH_SHA512_256_FLAG	_BIT(6)
#define CRYPTO_HASH_MD5_FLAG		_BIT(7)
#define CRYPTO_HASH_SM3_FLAG		_BIT(8)

#define CRYPTO_HMAC_VERSION		0x0690U
#define CRYPTO_HMAC_SHA1_FLAG		_BIT(0)
#define CRYPTO_HMAC_SHA256_FLAG		_BIT(1)
#define CRYPTO_HMAC_SHA512_FLAG		_BIT(2)
#define CRYPTO_HMAC_MD5_FLAG		_BIT(3)
#define CRYPTO_HMAC_SM3_FLAG		_BIT(4)

#define CRYPTO_CRYPTO_VERSION_NEW	0x06f0U

#define	CRYPTO_MEMORY_MAP0		0x00800U
...
#define	CRYPTO_SRAM_BASE		0x1000U
