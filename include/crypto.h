...
#define CRYPTO_MD5		((u32)BIT(0))
#define CRYPTO_SHA1		((u32)BIT(1))
#define CRYPTO_SHA256		((u32)BIT(2))
#define CRYPTO_SHA512		((u32)BIT(3))
#define CRYPTO_SM3		((u32)BIT(4))

#define CRYPTO_RSA512		((u32)BIT(10))
#define CRYPTO_RSA1024		((u32)BIT(11))
#define CRYPTO_RSA2048		((u32)BIT(12))
#define CRYPTO_RSA3072		((u32)BIT(13))
#define CRYPTO_RSA4096		((u32)BIT(14))
#define CRYPTO_SM2		((u32)BIT(15))
#define CRYPTO_ECC_192R1	((u32)BIT(16))
#define CRYPTO_ECC_224R1	((u32)BIT(17))
#define CRYPTO_ECC_256R1	((u32)BIT(18))

#define CRYPTO_DES		((u32)BIT(20))
#define CRYPTO_AES		((u32)BIT(21))
#define CRYPTO_SM4		((u32)BIT(22))

#define CRYPTO_HMAC_MD5		((u32)BIT(25))
#define CRYPTO_HMAC_SHA1	((u32)BIT(26))
#define CRYPTO_HMAC_SHA256	((u32)BIT(27))
#define CRYPTO_HMAC_SHA512	((u32)BIT(28))
#define CRYPTO_HMAC_SM3		((u32)BIT(29))

#define BYTE2WORD(bytes)	((bytes) / 4U)
#define BITS2BYTE(nbits)	((nbits) / 8U)
#define BITS2WORD(nbits)	((nbits) / 32U)
#define WORD2BYTE(words)	((words) * 4U)
