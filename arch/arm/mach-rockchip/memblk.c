...
const static struct memblk_attr plat_mem_attr[MEM_MAX] = {
	...
	MEM_DEFINE(UNCOMP_KERNEL,(F_IGNORE_INVISIBLE | F_FAIL_WARNING)),
	MEM_DEFINE(FIT_USER,     (F_OFC | F_KMEM_CAN_OVERLAP)),
	MEM_DEFINE(UIMAGE_USER,  (F_OFC | F_KMEM_CAN_OVERLAP)),
	MEM_DEFINE(AVB_ANDROID,  (F_OFC | F_CACHELINE_ALIGN | F_KMEM_CAN_OVERLAP | F_HIGHEST_MEM)),
	MEM_DEFINE(FIT,          (F_OFC | F_CACHELINE_ALIGN | F_KMEM_CAN_OVERLAP | F_HIGHEST_MEM)),
	MEM_DEFINE(UIMAGE,       (F_OFC | F_CACHELINE_ALIGN | F_KMEM_CAN_OVERLAP | F_HIGHEST_MEM)),
	MEM_DEFINE(RESOURCE,     (F_OFC)),
	MEM_DEFINE(SEARCH,       (F_OFC | F_CACHELINE_ALIGN | F_NO_FAIL_DUMP | F_KMEM_CAN_OVERLAP | F_HIGHEST_MEM)),
	/*
	 * Workarund:
	 *
