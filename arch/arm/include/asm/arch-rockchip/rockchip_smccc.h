...
#define SIP_ATF_VERSION			0x82000001UL
#define SIP_ACCESS_REG			0x82000002UL
#define SIP_SUSPEND_MODE		0x82000003UL
#define SIP_PENDING_CPUS		0x82000004UL
#define SIP_UARTDBG_CFG			0x82000005UL
#define SIP_UARTDBG_CFG64		0xc2000005UL
#define SIP_MCU_EL3FIQ_CFG		0x82000006UL
#define SIP_ACCESS_CHIP_STATE64		0xc2000006UL
#define SIP_SECURE_MEM_CONFIG		0x82000007UL
#define SIP_ACCESS_CHIP_EXTRA_STATE64	0xc2000007UL
#define SIP_DRAM_CONFIG			0x82000008UL
#define SIP_SHARE_MEM			0x82000009UL
#define SIP_SIP_VERSION			0x8200000aUL
#define SIP_REMOTECTL_CFG		0x8200000bUL
#define SIP_VPU_RESET			0x8200000cUL
#define SIP_SOC_BUS_DIV			0x8200000dUL
#define SIP_LAST_LOG			0x8200000eUL
#define SIP_ACCESS_MEM_OS_REG		0x8200000fUL
#define SIP_AMP_CFG			0x82000022UL
#define SIP_HDCP_CONFIG			0x82000025UL
#define SIP_MCU_CFG			0x82000028UL
